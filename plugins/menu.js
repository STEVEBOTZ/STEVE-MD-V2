...
let handler = async (m, { conn, usedPrefix, __dirname }) => {
  try {
    ...
    const ultah = new Date('Agustus 26 2023 00:00:01')
...
contextInfo: { externalAdReply :{ showAdAttribution: true,
                        sourceUrl: 'https://telegra.ph/file/74953efad62b27be268d3.jpg',
                        mediaType: 2,
                        description: `⚘ ᴄʀᴇᴀᴛᴇ Pahri`,
                        title: `💌 Ultah Owner : ${ohari} Hari ${ojam} Jam ${onet} Menit ${detek} Detik`,
                        body: `⚘ ᴄʀᴇᴀᴛᴇ by PahriXD`,          previewType: 0,
                        thumbnail: await (await fetch(giflogo2)).buffer(),
                        mediaUrl: 'https://telegra.ph/file/74953efad62b27be268d3.jpg'
